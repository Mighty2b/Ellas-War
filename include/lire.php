	...
	<table>
		<thead><tr class="centrer">
			...
			if(!empty($message->precedent) && is_numeric($message->precedent)) {
			  echo '<a href="lire-'.$message->precedent.'-'.$_GET['var2'].'"><img title="Flèche Droite" alt="Flèche Droite" src="images/utils/fleche_droite.png" style="float:left;" /></a> ';
			}
			...
			if(!empty($message->suivant) && is_numeric($message->suivant)) {
			  echo ' <a href="lire-'.$message->suivant.'-'.$_GET['var2'].'"><img title="Flèche Gauche" alt="Flèche Gauche" src="images/utils/fleche_gauche.png" /></a>';
			}
